...
export default function App() {
  ...
  const marketItems = useMemo(() => [
    { id: '1', title: 'iPhone 17 Pro Max 1TB', price: '$1,450', loc: 'Mogadishu', rating: '4.9 ⭐', verified: true },
    { id: '2', title: 'Modern Luxury Villa', price: '$280,000', loc: 'Hargeisa', rating: '5.0 ⭐', verified: true },
    { id: '3', title: 'MacBook Pro M4 Max', price: '$3,200', loc: 'Bosaso', rating: '4.8 ⭐', verified: false },
    { id: '4', title: 'Electric SUV Model X', price: '$65,000', loc: 'Kismayo', rating: '4.9 ⭐', verified: true }
  ], []);

  const chatItems = useMemo(() => [
    { id: '1', name: 'Ayaan Abdi', msg: 'Walaal xagee joogtaa?', time: '12:40 PM', unread: 2 },
    { id: '2', name: 'Jamaal Connect VIP Channel', msg: 'System V6 successfully deployed! 🚀', time: '11:15 AM', unread: 0 },
    { id: '3', name: 'Secret Encrypted Chat', msg: 'Self-destructing message active 🔒', time: 'Yesterday', unread: 0 }
  ], []);
          ...
          <ScrollView contentContainerStyle={styles.authContainer} showsVerticalScrollIndicator={false}>
            ...
            {authStep === 'Splash' && (
              <View style={{alignItems: 'center', justifyContent: 'center', flex: 1, width: '100%', minHeight: height * 0.8}}>
                <View style={styles.logoGlowLarge}>
                  <Text style={styles.logoMainTxtLg}>J</Text>
                </View>
                <Text style={styles.authTitle}>Jamaal Connect <Text style={{color: '#FFD700'}}>V6</Text></Text>
                <Text style={styles.authSub}>The Ultimate Super App</Text>
            ...
            {authStep === 'Welcome' && (
              <View style={{width: '100%', alignItems: 'center', flex: 1, justifyContent: 'center', minHeight: height * 0.8}}>
                <View style={styles.logoGlow}>
                  <Text style={styles.logoMainTxt}>J</Text>
                </View>
                <Text style={styles.authTitle}>Welcome to Jamaal Connect</Text>
                <Text style={styles.authSub}>Connect, Buy, Sell, Pay and Build with AI</Text>
            ...
            {authStep === 'Language' && (
              <View style={{width: '100%', flex: 1, justifyContent: 'center', minHeight: height * 0.8}}>
                ...
                <Text style={styles.authSub}>Select your preferred app language</Text>
                {['English', 'Somali', 'Arabic', 'Swahili', 'French'].map((lang, i) => (
            ...
            {authStep === 'Country' && (
              <View style={{width: '100%', flex: 1, justifyContent: 'center', minHeight: height * 0.8}}>
                ...
                <Text style={styles.authSub}>Configure currency and timezone</Text>
                {['Somalia (+252)', 'Djibouti (+253)', 'Kenya (+254)', 'UAE (+971)', 'UK (+44)'].map((c, i) => (
            ...
            {authStep === 'Signup' && (
              <View style={{width: '100%', paddingVertical: 20}}>
                ...
                <Text style={styles.authSub}>Join the ecosystem</Text>
            ...
            {authStep === 'OTP' && (
              <View style={{width: '100%', flex: 1, justifyContent: 'center', alignItems: 'center', minHeight: height * 0.8}}>
                ...
                <Text style={styles.authSub}>Enter 6-digit code sent to your phone</Text>
            ...
            {authStep === 'ProfileSetup' && (
              <View style={{width: '100%', paddingVertical: 20}}>
                ...
                <Text style={styles.authSub}>Tell us more about yourself</Text>
                <TextInput style={styles.input} placeholder="Bio / Status" placeholderTextColor="#888" />
                <TextInput style={styles.input} placeholder="Profession / Title" placeholderTextColor="#888" />
            ...
            {authStep === 'SecuritySetup' && (
              <View style={{width: '100%', flex: 1, justifyContent: 'center', minHeight: height * 0.8}}>
                ...
                <Text style={styles.authSub}>Protect your wallet and chats</Text>
                {['Enable Face ID / Fingerprint', 'Create 6-Digit PIN', 'Setup Two-Factor Auth'].map((sec, i) => (
        ...
        <View style={styles.mainWrapper}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              <View style={styles.header}>
                <View style={styles.row}>
                  <View style={styles.smallLogo}><Text style={{color: '#FFD700', fontWeight: 'bold'}}>J</Text></View>
                  <Text style={styles.headerTitle}>Jamaal Connect <Text style={{color: '#FFD700'}}>V6</Text></Text>
                </View>
                <View style={styles.row}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{marginVertical: 6}}>
                {[
                  ...
                  { name: 'Following Feed', icon: 'people-outline' },
                  { name: 'Friends Feed', icon: 'person-add-outline' },
                  { name: 'Nearby Feed', icon: 'location-outline' },
                  { name: 'Videos Feed', icon: 'videocam-outline' },
                  { name: 'Marketplace Feed', icon: 'basket-outline' },
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => {
                      ...
                      if (item.name === 'Marketplace Feed') handleNavigation('Market');
                    }}>
                    <Ionicons name={item.icon} size={13} color={activeHomeTab === item.name ? '#130B2B' : '#FFD700'} style={{marginRight: 4}} />
              ...
              <View style={styles.searchBar}>
                ...
                <TextInput style={{flex: 1, color: '#FFF', fontSize: 12}} placeholder="Search Users, Posts, Reels, Marketplace, Jobs..." placeholderTextColor="#888" value={searchQuery} onChangeText={setSearchQuery} />
                <View style={styles.row}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{marginVertical: 8}}>
                {['Add Story', 'Live Story', 'Ayaan Omar', 'Hassan Ali', 'Fadumo Xasan', 'Khaalid Dev'].map((item, index) => index === 0 ? (
                  <View key={index} style={styles.storyCardAdd}>
                    <View style={styles.storyRingAdd}><Ionicons name="add" size={20} color="#130B2B" /></View>
              ...
              <View style={styles.glassCard}>
                <View style={styles.spaceBetween}>
                  <View style={styles.row}>
                    <View style={styles.avatarSm}><Ionicons name="person" size={12} color="#130B2B" /></View>
                    <View style={{marginLeft: 8}}>
                      <Text style={styles.authorTxt}>Ayaan Omar • Verified</Text>
                      <Text style={styles.timeTxt}>Just now • AI Recommended</Text>
                    </View>
                  </View>
                  <View style={styles.row}>
                ...
                <Text style={styles.postText}>Jamaal Connect V6 waa app-ka ugu casrisan uguna xawaaraha badan ee taariikhda la sameeyay. React Native + Expo! 🚀✨</Text>
                
                <View style={styles.mediaContainer}>
                  <Ionicons name="shield-checkmark" size={48} color="#FFD700" />
                  <Text style={{color: '#FFD700', fontSize: 11, fontWeight: 'bold', marginTop: 6}}>Encrypted HD Media Stream</Text>
                </View>
          ...
          {currentScreen === 'Market' && (
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{marginVertical: 6}}>
                {['All', 'Cars', 'Houses', 'Phones', 'Electronics', 'Fashion', 'Jobs', 'Hotels'].map((cat) => (
          ...
          {currentScreen === 'Reels' && (
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', paddingBottom: 80}}>
              <View style={styles.reelsBox}>
                ...
                <Text style={styles.reelsTitle}>TikTok Style Infinite Reels V6</Text>
                <Text style={styles.reelsSub}>Auto-play, AI Subtitles, Gifts, Remix, Duet & Speed Control</Text>
              </View>
            </View>
          )}
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              ...
              {chatItems.map((c) => (
                <TouchableOpacity key={c.id} style={styles.chatRow}>
                  <View style={styles.avatarSm}><Ionicons name="person" size={14} color="#130B2B" /></View>
                  ...
                  {c.unread > 0 && <View style={styles.unreadBadge}><Text style={{color: '#130B2B', fontSize: 9, fontWeight: 'bold'}}>{c.unread}</Text></View>}
                </TouchableOpacity>
              ))}
            </ScrollView>
          )}
          ...
          {currentScreen === 'Profile' && (
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              ...
              <View style={styles.profileBox}>
                <View style={styles.avatarLg}><Ionicons name="person" size={28} color="#130B2B" /></View>
                <Text style={styles.profileName}>Abdirahman Ali <Ionicons name="checkmark-circle" size={14} color="#FFD700" /></Text>
                <Text style={styles.profileHandle}>@abdirahman_dev • Verified Creator</Text>
                <Text style={styles.profileBio}>Building Jamaal Connect V6 Ultimate Super App. 🚀</Text>

                <View style={styles.profileStatsRow}>
                  <View style={{alignItems: 'center'}}><Text style={styles.statNum}>14.2K</Text><Text style={styles.statLbl}>Followers</Text></View>
                  <View style={{alignItems: 'center'}}><Text style={styles.statNum}>420</Text><Text style={styles.statLbl}>Following</Text></View>
                  <View style={{alignItems: 'center'}}><Text style={styles.statNum}>1.8M</Text><Text style={styles.statLbl}>Reels</Text></View>
                </View>
              </View>
            </ScrollView>
          )}
          ...
          {currentScreen === 'Wallet' && (
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              <View style={styles.header}>
                <Text style={styles.sectionHeader}>Super Wallet</Text>
              ...
              <View style={styles.walletCard}>
                <Text style={{color: '#FFD700', fontWeight: 'bold', fontSize: 12}}>JAMAAAL V6 INFINITE SUPER WALLET</Text>
                <Text style={{color: '#AAA', fontSize: 11, marginTop: 12}}>Total Combined Balance</Text>
                <Text style={{color: '#FFD700', fontSize: 26, fontWeight: 'bold', marginVertical: 4}}>$48,250.00</Text>
                
                <Text style={{color: '#FFD700', fontWeight: 'bold', fontSize: 11, marginTop: 16}}>Supported Currencies & Cryptos</Text>
                <View style={styles.walletGrid}>
                  {['Binance', 'USDT', 'Solana', 'Bitcoin', 'ZAAD', 'Sahal', 'eDahab', 'Visa', 'Mastercard', 'Apple Pay'].map((w, i) => (
          ...
          {currentScreen === 'AI' && (
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              <View style={styles.header}>
                <Text style={styles.sectionHeader}>Jamaal AI Neural Core</Text>
                <TouchableOpacity style={styles.topIcon} onPress={() => handleNavigation('Home')}><Ionicons name="close" size={18} color="#FFD700" /></TouchableOpacity>
              </View>

              <View style={styles.aiHero}>
                <Ionicons name="sparkles" size={32} color="#FFD700" />
                <Text style={styles.aiTitle}>Next-Gen AI Neural Studio</Text>
                <Text style={styles.aiSub}>Generate images, videos, code, business models, and voice calls instantly.</Text>
              </View>
            </ScrollView>
          )}
          ...
          {currentScreen === 'Settings' && (
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              ...
              {['Account', 'Security', 'Privacy', 'Notifications', 'Appearance', 'Language', 'Wallet Settings', 'Help Center'].map((item, index) => (
          ...
          {currentScreen === 'Notifications' && (
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 90}}>
              ...
              {['Likes', 'Comments', 'Marketplace Orders', 'Wallet Alerts', 'AI Updates'].map((item, index) => (
                <TouchableOpacity key={index} style={styles.chatRow}>
                  ...
                  <View style={{flex: 1}}>
                    ...
                    <Text style={styles.chatPreview}>New update regarding your activity stream.</Text>
                  </View>
                </TouchableOpacity>
              ))}
            </ScrollView>
        ...
        {isFabOpen && (
          <View style={styles.fabModalContainer}>
            ...
            <View style={styles.fabMenuBox}>
              ...
              {[
                { name: '➕ Post', action: () => handleNavigation('Home') },
                { name: '📹 Reel', action: () => handleNavigation('Reels') },
                { name: '🛒 Sell Product', action: () => handleNavigation('Market') },
                { name: '🤖 AI Create', action: () => handleNavigation('AI') }
              ].map((item, i) => (
            ...
            <TouchableOpacity key={i} style={styles.navItem} onPress={() => {
              ...
              {item.special ? (
                <View style={styles.fabButton}>
                  <Ionicons name={isFabOpen ? 'close' : 'add'} size={24} color="#130B2B" />
                </View>
              ) : (
                <>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#130B2B' },
  authContainer: { padding: 20, justifyContent: 'center', alignItems: 'center', flexGrow: 1 },
  logoGlow: { width: 64, height: 64, borderRadius: 20, backgroundColor: '#1E143F', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#FFD700', marginBottom: 12 },
  logoGlowLarge: { width: 90, height: 90, borderRadius: 25, backgroundColor: '#1E143F', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#FFD700', marginBottom: 16 },
  ...
  input: { width: '100%', backgroundColor: '#1E143F', padding: 12, borderRadius: 14, color: '#FFF', fontSize: 12, marginBottom: 10, borderWidth: 1, borderColor: '#2D2056' },
  selectionCard: { width: '100%', backgroundColor: '#1E143F', padding: 14, borderRadius: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, borderWidth: 1, borderColor: '#2D2056' },
  primaryBtn: { width: '100%', backgroundColor: '#FFD700', padding: 14, borderRadius: 14, alignItems: 'center', marginTop: 6 },
  primaryBtnTxt: { color: '#130B2B', fontWeight: 'bold', fontSize: 13 },
  secondaryBtn: { width: '100%', backgroundColor: '#1E143F', padding: 14, borderRadius: 14, alignItems: 'center', marginTop: 10, borderWidth: 1, borderColor: '#2D2056' },
  ...
  smallLogo: { width: 26, height: 26, borderRadius: 8, backgroundColor: '#1E143F', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#FFD700' },
  topIcon: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#1E143F', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#2D2056', marginLeft: 6 },

  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1E143F', borderRadius: 16, paddingHorizontal: 12, paddingVertical: 8, marginBottom: 8, borderWidth: 1, borderColor: '#6C3BFF55' },
  ...
  storyCard: { width: 60, height: 80, backgroundColor: '#1E143F', borderRadius: 14, marginRight: 8, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#2D2056' },
  storyRing: { width: 36, height: 36, borderRadius: 18, borderWidth: 2, borderColor: '#FFD700', justifyContent: 'center', alignItems: 'center', backgroundColor: '#6C3BFF', marginBottom: 4 },
  storyRingAdd: { width: 36, height: 36, borderRadius: 18, justifyContent: 'center', alignItems: 'center', backgroundColor: '#130B2B', marginBottom: 4 },
  storyTxt: { color: '#AAA', fontSize: 9 },

  glassCard: { backgroundColor: '#1E143F', padding: 12, borderRadius: 20, marginBottom: 10, borderWidth: 1, borderColor: '#2D2056' },
  ...
  mediaContainer: { width: '100%', height: 130, backgroundColor: '#170E32', borderRadius: 14, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#2D2056' },
  ...
  chip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#1E143F', borderRadius: 12, marginRight: 6, borderWidth: 1, borderColor: '#2D2056' },
  chipActive: { backgroundColor: '#FFD700' },
  chipTxt: { color: '#AAA', fontSize: 10, fontWeight: '600' },
  chipTxtActive: { color: '#130B2B', fontWeight: 'bold' },

  gridContainer: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  marketCard: { width: '48%', backgroundColor: '#1E143F', borderRadius: 16, padding: 10, marginBottom: 10, borderWidth: 1, borderColor: '#2D2056', marginHorizontal: '1%' },
  marketImgBox: { width: '100%', height: 90, backgroundColor: '#170E32', borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
  ...
  badgeOverlay: { position: 'absolute', top: 6, right: 6, backgroundColor: '#130B2B', padding: 2, borderRadius: 6 },
  ...
  marketBtnSmOutline: { flex: 1, backgroundColor: '#170E32', padding: 6, borderRadius: 8, alignItems: 'center', marginLeft: 4, borderWidth: 1, borderColor: '#FFD70055' },
  marketBtnTxt: { color: '#130B2B', fontSize: 10, fontWeight: 'bold' },
  marketBtnTxtOutline: { color: '#FFD700', fontSize: 10, fontWeight: 'bold' },

  reelsBox: { width: '90%', backgroundColor: '#1E143F', borderRadius: 20, justifyContent: 'center', alignItems: 'center', padding: 20, borderWidth: 1, borderColor: '#2D2056' },
  ...
  chatRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1E143F', padding: 10, borderRadius: 16, marginBottom: 8, borderWidth: 1, borderColor: '#2D2056' },
  ...
  profileBox: { backgroundColor: '#1E143F', borderRadius: 20, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#2D2056' },
  ...
  profileStatsRow: { flexDirection: 'row', justifyContent: 'space-around', width: '100%', paddingVertical: 10, borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#2D2056', marginBottom: 10 },
  statNum: { color: '#FFD700', fontWeight: 'bold', fontSize: 13 },
  statLbl: { color: '#888', fontSize: 9 },

  walletCard: { backgroundColor: '#1E143F', padding: 16, borderRadius: 20, borderWidth: 1, borderColor: '#FFD70055' },
  walletGrid: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 8 },
  walletChip: { backgroundColor: '#170E32', paddingHorizontal: 8, paddingVertical: 5, borderRadius: 8, margin: 3, borderWidth: 1, borderColor: '#2D2056' },

  aiHero: { backgroundColor: '#1E143F', borderRadius: 20, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#6C3BFF55' },
  ...
  fabModalContainer: { position: 'absolute', bottom: 70, left: 0, right: 0, backgroundColor: 'rgba(0,0,0,0.6)', height: height, justifyContent: 'flex-end', zIndex: 99 },
  fabMenuBox: { backgroundColor: '#1E143F', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, borderWidth: 1, borderColor: '#FFD70055' },
  fabMenuItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#2D2056' },

  bottomNav: { position: 'absolute', bottom: 0, left: 0, right: 0, height: 60, backgroundColor: '#130B2B', borderTopWidth: 1, borderTopColor: '#261A4E', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' },
